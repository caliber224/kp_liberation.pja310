...
huron_typename = "rhsusf_CH53E_USMC";									// This is Spartan 01, a multipurpose mobile respawn as a helicopter. 																	Default is "B_Heli_Transport_03_unarmed_F".
...
KP_liberation_little_bird_classname = "RHS_UH1Y_UNARMED_d";				// These are the little birds which spawn on the Freedom or at Chimera base.															Default is "B_Heli_Light_01_F".
